...
const Portfolio: NextPage = () => {
  ...
  return (
    <div>
      <Navbar />
      <section className="max-w-4xl mx-auto py-8 px-4 py-8 sm:px-6 lg:px-8">
        {/* Tabs */}
        <nav className="bg-white shadow overflow-hidden rounded-lg mb-8">
          ...
          {showTabOne && (
            <ul>
              <HoldingSection name="Advanced Enzyme">
                <>
                  <p className="mt-4">
                    Advanced Enzyme is the largest Indian enzyme company engaged
                    in the research and development, manufacturing, and
                    marketing of over 400 proprietary products. It primarily
                    caters to customers in the US and Indian markets through its
                    human nutrition, animal nutrition, and bio-processing
                    segments.
                  </p>
                  <p className="mt-4">
              ...
              <HoldingSection name="Ahluwalia Contracts">
                <>
                  <p className="mt-4">
                    ...
                    engineering & construction company. Today, Ahluwalia is one
                    of India's top-5 contractors focused on buildings and
                    ...
                    apartment blocks and malls. Ahluwalia also builds factories,
                    civil structures for power-plants, metro-stations, airport
                    terminals and sports-stadiums.
                  </p>
                  <p className="mt-4">
                    Ahluwalia website:{" "}
              ...
              <HoldingSection name="AIA Engineering">
                <>
                  <p className="mt-4">
                    ...
                    wear, corrosion and abrasion resistant castings used in the
                    cement, mining and thermal power generation industries. In
                    this industry, AIA is largest player in India and the second
                    largest globally.
                  </p>
                  <p className="mt-4">
                    AIA website:{" "}
              ...
              <HoldingSection name="Amara Raja">
                <>
                  <p className="mt-4">
                    ...
                    largest lead acid battery company. Amara's storage batteries
                    cover a broad spectrum of applications such as automotive
                    (for both OEM and replacement market), power back-up and
                    industrial. From a standing start in 2000, Amara's Amaron
                    brand has built a credible #2 position in the attractive
                    automotive lead acid battery market with sharp focus and
              ...
              <HoldingSection name="Cera Sanitaryware">
                <>
                  <p className="mt-4">
                    ...
                    in India. The company sells sanitaryware, faucets and tiles
                    under the 'Cera' brand.
                  </p>
                  <p className="mt-4">
                    Cera website:{" "}
                    <a href="https://www.cera-india.com">www.cera-india.com</a>
                  </p>
                </>
              </HoldingSection>
              <HoldingSection name="DB Corp">
                <>
                  <p className="mt-4">
                    ...
                    or credible #2 in most markets that it operates. In addition
                    to the newspapers, DB Corp also operates an FM radio network
                    and web portals.
                  </p>
                  <p className="mt-4">
                    DB Corp website:{" "}
                    <a href="https://www.bhaskarnet.com">www.bhaskarnet.com</a>
                  </p>
                </>
              </HoldingSection>
              ...
              <HoldingSection name="Genpact">
                <>
                  <p className="mt-4">
                    ...
                    the US, UK, Australia and Japan, including more than 100 of
                    the Fortune 500 companies, from a global network of delivery
                    locations.
                  </p>
                  <p className="mt-4">
                    Genpact website:{" "}
              ...
              <HoldingSection name="GESCO">
                <>
                  <p className="mt-4">
                    ...
                    businesses: shipping and offshore. The shipping business is
                    involved in transportation of crude oil, petroleum products,
                    gas and dry bulk commodities. The offshore business,
                    conducted through GESCO's wholly owned subsidiary Greatship
                    (India) Limited, helps oil companies in conducting oil
                    exploration and production activities in shallow waters.
                  </p>
                  <p className="mt-4">
                    GESCO website:{" "}
              ...
              <HoldingSection name="Havells">
                <>
                  <p className="mt-4">
                    ...
                    products ranging across switchgear, cables & wires, motors,
                    fans, CFL/LED lamps, luminaires, switches, water heaters and
                    domestic appliances. Havells entered large home appliances
                    market (primarily air conditioners) by acquiring Lloyd in
                    mid-2017.
                  </p>
                  <p className="mt-4">
                    Havells website:{" "}
              ...
              <HoldingSection name="Info Edge">
                <>
                  <p className="mt-4">
                    ...
                    <a href="https://www.99acres.com">www.99acres.com</a> is the
                    leader in India's nascent on-line real estate classifieds
                    space. Info Edge also has investments in Zomato and
                    Policybazaar.
                  </p>
                  <p className="mt-4">
                    Info Edge website:{" "}
              ...
              <HoldingSection name="Jyothy Labs">
                <>
                  <p className="mt-4">
                    Jyothy Labs Limited (JLL) was founded by MP Ramachandran in
                    Kerala in 1983. Today, JLL is a leading player in India in
                    fabric care, dishwashing, household insecticides and
                  ...
                  <p className="mt-4">
                    Jyothy Labs website:{" "}
                    <a href="https://www.jyothylabs.com">www.jyothylabs.com</a>
                  </p>
                </>
              </HoldingSection>
              <HoldingSection name="Matrimony">
                <>
                  <p className="mt-4">
                    Matrimony.com Ltd (Matrimony) delivers matchmaking services
                    to its users in India and the Indian diaspora outside India
                    through its websites, mobile sites and mobile apps
                    complemented by its on-the-ground network in India.
                    Matrimony is the leader in matchmaking services in India
                    with ~60% revenue share and operates 300+ community
              ...
              <HoldingSection name="NRB Bearings">
                <>
                  <p className="mt-4">
                    ...
                    needle roller bearings for automotive applications in India.
                    In addition, NRB also sells cylindrical bearings to
              ...
              <HoldingSection name="Sundaram Finance">
                <>
                  <p className="mt-4">
                    ...
                    oldest, most trusted and prudently managed NBFCs. Founded in
                    1954 with a focus on truck finance, Sundaram has since
                    widened its scope to include lending for purchase of cars,
                    construction equipment, tractors and other commercial
                    vehicles. Through its subsidiaries, Sundaram is also present
                    in home loans, general insurance and asset management.
                  </p>
                  <p className="mt-4">
                    Sundaram website:{" "}
              ...
              <HoldingSection name="Supreme">
                <>
                  <p className="mt-4">
                    Supreme is India's leading plastics products company. It has
                    a diversified product portfolio across plastic pipes and
                    fittings, industrial, consumer and packaging divisions. In
                    addition, it owns 30% of Supreme Petrochem, India's largest
              ...
              <HoldingSection name="Triveni Turbine">
                <>
                  <p className="mt-4">
                    ...
                    manufacturer. It has a dominant market share of over 60% in
                    India in sub-30MW steam turbines .It also has a strong
              ...
              <HoldingSection name="TTK Prestige">
                <>
                  <p className="mt-4">
                    TTK Prestige is India's largest kitchen products company. It
                    sells a wide range of products such as pressure cookers,
                    cookware and small domestic appliances under the well-known
                    'Prestige' brand, through its extensive distribution network
                    across India.
                  </p>
                  <p className="mt-4">
              ...
              <HoldingSection name="V-Guard">
                <>
                  <p className="mt-4">
                    ...
                    inverters. The company sells its product under the 'V-Guard'
                    brand.
                  </p>
                  <p className="mt-4">
                    V-Guard website:{" "}
              ...
              <HoldingSection name="Voltamp Transformers">
                <>
                  <p className="mt-4">
                    Voltamp is India's leading manufacturer of transformers for
                    industrial and building applications. Voltamp mostly sells
                    to private sector projects (buildings and factories),
                    offering a full product-range spanning both oil-filled and
              ...
              <HoldingSection name="WNS">
                <>
                  <p className="mt-4">
                    ...
                    provider. WNS primarily serves clients in travel, financial
                    services, healthcare, utilities and manufacturing industries
                    in the UK, US, and Australia, from a global network of
                    delivery locations.
                  </p>
                  <p className="mt-4">
              ...
              <ul>
                <HoldingSection name="Carborundum Universal">
                  <p className="mt-4">
                    ...
                    voltage, chemical corrosion or physical wear-and-tear. CUMI
                    has built a sizeable international business as well, both
                ...
                <HoldingSection name="Exide">
                  <p className="mt-4">
                    ...
                    broad spectrum of applications such as automotive (for both
                    OEM and replacement market), power back-up and industrial.
                    With geographically distributed manufacturing plants at
                    strategic locations, pan-India sales and service network,
                    well-known brands, and backward integration for lead
                    sourcing, Exide has built a strong consumer franchise in
                    India.
                  </p>
                  <p className="mt-4">
                    Exide website:{" "}
                ...
                <HoldingSection name="Kirloskar Oil Engines">
                  <p className="mt-4">
                    ...
                    manufacturer of off-highway engines, covering a power range
                    of 3hp to 11,000hp. The primary application of KOEL's
                    engines is in its 'Kirloskar GREEN' branded generator-sets,
                    which is India's largest selling genset brand. KOEL's
                    engines are also used in industrial & construction
                    machinery, tractors, agricultural pumpsets and marine
                    applications.
                  </p>
                  <p className="mt-4">
                    KOEL website:{" "}
                    <a href="https://koel.kirloskar.com">koel.kirloskar.com</a>
                  </p>
                </HoldingSection>
                <HoldingSection name="KKCL">
                  ...
                  <p className="mt-4">
                    KKCL website:{" "}
                    <a href="https://www.kewalkiran.com">www.kewalkiran.com</a>
                  </p>
                </HoldingSection>
                <HoldingSection name="Lovable">
                  <p className="mt-4">
                    Lovable Lingerie Ltd (LLL) manufactures and markets women's
                    branded innerwear in India. LLL has two major brands -
                    Lovable (premium brand launched in 1995) and Daisy Dee
                    (mid-market brand launched in 2005).
                  </p>
                  <p className="mt-4">
                    LLL website:{" "}
                ...
                <HoldingSection name="Shree Cement">
                  <p className="mt-4">
                    Shree Cement is India's most efficient cement producer, with
                    a proven track record of low-cost operations and timely
                    capacity expansion. Shree enjoys a leadership position in
                    the North Indian cement market.
                  </p>
                  <p className="mt-4">
                    Shree Cement website:{" "}
                    <a href="https://www.shreecement.in">www.shreecement.in</a>
                  </p>
                </HoldingSection>
                <HoldingSection name="Sun TV">
                  <p className="mt-4">
                    ...
                    South India, and a strong #2 player in the fourth state. It
                    operates over 20 channels that offer general entertainment,
                    movies, news, kids and music programming in Tamil, Telugu,
                    Kannada and Malayalam languages. In addition, it produces
                    movies and operates over 40 radio stations in India.
                  </p>
                  <p className="mt-4">
                    Sun TV website:{" "}
              ...
              <ul>
                <HoldingSection name="Just Dial">
                  <p className="mt-4">
                    ...
                    platform has listings of tens of millions of local SMEs and
                    their products/services, augmented with verified
                    location/contact information and consumer ratings. Consumers
                    can search this database across multiple channels such as
                    voice-calls, sms, PC internet, mobile internet and mobile
                    app in a seamless manner, enabling them to find relevant
                    local vendors in a timely manner for their diverse
                    requirements. For most local SMEs, running campaigns on JD
                    is their primary and most effective lead generation channel.
                    JD also offers 'search plus' services, wherein consumers can
                    complete bookings and purchases on JD's platform.
                  </p>
                  <p className="mt-4">
                    Just Dial website:{" "}
                ...
                <HoldingSection name="MindTree">
                  <p className="mt-4">
                    ...
                    with deep expertise in its chosen set of industry verticals
                    (Travel/Hospitality, Retail/CPG, BFSI, High-tech) and
                    service offerings (Digital Transformation, Infrastructure
                    Management, Testing, ERP, Engineering Services).
                  </p>
                  <p className="mt-4">
                    MindTree website:{" "}
                ...
                <HoldingSection name="Thyrocare">
                  <p className="mt-4">
                    ...
                    of pathology lab testing services in India. Thyrocare's 100%
                    owned subsidiary Nueclear Healthcare Limited ('Nueclear')
                    provides whole-body scans for cancer-related testing.
                  </p>
                  <p className="mt-4">
                    Thyrocare website:{" "}
